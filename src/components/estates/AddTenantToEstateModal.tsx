...
interface AddTenantToEstateModalProps {
  isOpen: boolean;
  onClose: () => void;
  onAdd: (tenant: Omit<User, 'id' | 'createdAt'>) => void;
  estate: Estate;
}

export const AddTenantToEstateModal: React.FC<AddTenantToEstateModalProps> = ({ 
  isOpen, 
  onClose, 
  onAdd, 
  estate 
      ...
      <div className="bg-white rounded-xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Adding to {estate.name}</p>
          </div>
          <button
            onClick={onClose}
